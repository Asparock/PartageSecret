...
public class Protocole1_K extends javax.swing.JFrame {
    ...
    private void createKeysActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createKeysActionPerformed
        if(!this.secretBin.getText().equals("")){
            ArrayList<String> keys = this.simpleMan.getKeysFromSecret(this.secretString.getText());
            this.Key_2.setText(keys.get(0));
            this.Key_1.setText(keys.get(1));           
        } else {
